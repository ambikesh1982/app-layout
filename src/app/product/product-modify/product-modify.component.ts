...
export class ProductModifyComponent implements OnInit, OnDestroy {
  ...
  enableProductSubmission: boolean;
  // productForm1Completed: boolean;
  // productForm2Completed: boolean;
  ...
  constructor(
    ...
    this.enableProductSubmission = false;
    ...
    // this.subscription = this.productForm.statusChanges.subscribe(status => {
    //   console.log('ProductForm status >>>> ', status);
    //   // console.log('Form1 status >>>> ', status.get('form1').status);
    //   // console.log('Form1 status >>>> ', status.get('form2').status);
    //   // console.log('Form1 status >>>> ', status.get('addressForm').status);
    // });
  ...
  ngOnInit() {
    ...
    if (this.fooditem) {
      ...
      console.log('Create New fooditem.');
